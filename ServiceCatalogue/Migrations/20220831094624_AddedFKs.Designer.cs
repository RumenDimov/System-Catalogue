...
namespace ServiceCatalogue.Migrations
{
    ...
    [Migration("20220831094624_AddedFKs")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServiceCatalogue.Model.SystemAsset", b =>
                {
                    ...
                    b.Property<int?>("ServerTermsServerId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ServerTermsServerId");
            ...
            modelBuilder.Entity("ServiceCatalogue.Model.SystemAsset", b =>
                {
                    b.HasOne("ServiceCatalogue.Model.ServerAsset", "ServerTerms")
                        .WithMany("SystemAssets")
                        .HasForeignKey("ServerTermsServerId");
                });
