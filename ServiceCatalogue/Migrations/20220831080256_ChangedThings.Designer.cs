...
namespace ServiceCatalogue.Migrations
{
    ...
    [Migration("20220831080256_ChangedThings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServiceCatalogue.Model.SystemAsset", b =>
                {
                    ...
                    b.Property<int?>("ServerNameServerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ServiceCatalogue.Model.ServerAsset", b =>
                {
                    b.HasOne("ServiceCatalogue.Model.AppRole", "Role")
                        .WithOne("ServerAsset")
                        .HasForeignKey("ServiceCatalogue.Model.ServerAsset", "AppRoleId")
            ...
            modelBuilder.Entity("ServiceCatalogue.Model.SystemAsset", b =>
                {
                    b.HasOne("ServiceCatalogue.Model.ServerAsset", "ServerName")
                        .WithMany()
                        .HasForeignKey("ServerNameServerId");
                });
